const GrayImage = require("../../../src/operator/conversions/GrayImage");
const opencvMock = require("../opencv-mocks/conversions.mock");
...
describe("GrayImage Operator", () => {
  ...
  it("should process cvtColor function to gray the image", () => {
    ...
    expect(opencvMock.cv2.cvtColor).toHaveBeenCalledWith(imageMock, {}, "mockColorBGR2GRAY");
  });
});
