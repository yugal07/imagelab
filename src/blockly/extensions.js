...
Blockly.Extensions.register("file_button", function () {
  ...
  this.getField("file_browse").clickHandler_ = () => {
    ...
    const input = document.getElementById("inputImage"); // inputImage is the html element of button that opens the file explorer and it is hidden in that case.
    input.click();
  };
});
...
Blockly.Extensions.register("folder_button", function () {
  ...
  this.getField("folder_browse").clickHandler_ = () => {
    ...
    const output = document.getElementById("outputDirectory"); // outputDirectory is the html element of button that opens the file explorer and it is hidden in that case.
    output.click();
  };
});
